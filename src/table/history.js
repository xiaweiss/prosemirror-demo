...
function applyTransaction(history, state, tr, options) {
  if (tr.getMeta('replaceHistory') === true) {
    return new HistoryState(history.done, history.undone, history.prevRanges, history.prevTime)
  }
...
// :: (Transaction) → Transaction
// Set a flag on the given transaction that will replace last step
// It can be used to skip some step to history (author: Xiawei)
export function replaceHistory(tr) {
  return tr.setMeta(replaceHistoryKey, true)
}
