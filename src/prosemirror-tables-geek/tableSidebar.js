...
import {CellSelection, TableMap} from "./index"
...
class sidebarDecoration {
  ...
  renderSelectTable () {
    ...
    sidebarSelectTable.className = 'ProseMirror-tableSidebar-select-table'
  ...
  renderCol () {
    ...
    this.cells.push(Decoration.widget(tableEnd, view => {
      ...
      sidebarColContainer.className = 'ProseMirror-tableSidebar ProseMirror-tableSidebar-col-container'
